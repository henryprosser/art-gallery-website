export default function Hero() {
  return (
    <section className="md:flex md:relative">
      ...
      {/* Gallery Info */}
      <div className="flex flex-col gap-[var(--spacing-32)] mt-[var(--spacing-32)] mr-[var(--spacing-16)] ml-[var(--spacing-16)] md:absolute md:top-1/2 md:left-[389px] md:translate-y-[-50%] md:mx-0 md:my-0 md:mr-[var(--spacing-40)] md:gap-[var(--spacing-48)] lg:gap-[var(--spacing-64)] lg:left-[924px] lg:w-[350px] lg:translate-y-[-55%] lg:mr-0">
